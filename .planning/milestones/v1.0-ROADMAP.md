...
- [x] **Phase 4: Frontend Split** — Wire ChatPane, extract panel components, introduce SessionProvider context (completed 2026-09-04)
...
| 4 | Frontend Split | 7/7 | Complete   | 2026-09-04 |
...
- [x] 03-04-PLAN.md — TaskRegistry directive handoff store + restart crash-detection (PERSIST-01)
...
- [x] 04-04-PLAN.md — Rewrite ChatPane.tsx: /ws/chat URL, ?token= auth, handshake, 3-shape router (UI-01/D-01/D-02/D-03/D-11/D-12)
- [x] 04-05-PLAN.md — Extract panels batch 1: Scope/Directives/Plan/Agent/Health (UI-02/D-04)
- [x] 04-06-PLAN.md — Extract panels batch 2: StatusBar/Terminal trio/Findings (UI-02/D-04)
- [x] 04-07-PLAN.md — Rewrite App.jsx composition root: render ChatPane, wrap panels in ErrorBoundary, provide SessionContext (UI-01/UI-02/UI-03)
**UI hint**: yes
