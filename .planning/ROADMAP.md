...
| 4 | Frontend Split | 6/7 | In Progress|  |
...
- [ ] 04-07-PLAN.md — Rewrite App.jsx composition root: render ChatPane, wrap panels in ErrorBoundary, provide SessionContext (UI-01/UI-02/UI-03)
**UI hint**: yes
