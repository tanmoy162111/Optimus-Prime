...
|---|-------|------|--------------|-------|
| 1 | Cleanup & Configuration | Dead code gone, model string correct, import graph clean | CLEAN-01, CLEAN-02 | 3 plans |
...
**Plans:** 3 plans
- [ ] 01-01-PLAN.md — Fix Claude model identifier in backend/config.py and add regression test
